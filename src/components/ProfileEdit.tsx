...
export function ProfileEdit({ onBack, onNavigate, nickname: initialNickname, onSave }: ProfileEditProps) {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="flex items-center justify-center p-4">
          ...
          <h1 className="text-gray-900">프로필 수정</h1>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center py-8">
        <div className="relative">
          ...
          <button className="absolute bottom-0 right-0 w-10 h-10 bg-white rounded-full border-2 border-gray-200 flex items-center justify-center shadow-lg">
      ...
      <div className="px-4">
        <button 
          ...
          className="w-full py-4 bg-gray-200 text-gray-700 rounded-xl hover:bg-gray-300 transition-colors"
        >
          수정 완료
        </button>
      </div>
